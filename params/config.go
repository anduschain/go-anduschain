...
var (
	...
	AllDebProtocolChanges = &ChainConfig{big.NewInt(33558), nil, nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), nil, nil, nil, nil, nil, &DebConfig{Epoch: 100, FairAddr: common.Address{}}}
)
