...
import (
	...
	"github.com/anduschain/go-anduschain/eth/protocols/snap"
	"github.com/anduschain/go-anduschain/p2p"
	"github.com/anduschain/go-anduschain/p2p/enode"
...
func getChain() *core.BlockChain {
	...
	blocks, _ := core.GenerateChain(gspec.Config, genesis, deb.NewFaker(), db, 2,
	...
	bc, _ := core.NewBlockChain(db, cacheConf, gspec.Config, deb.NewFaker(), vm.Config{}, nil, nil)
