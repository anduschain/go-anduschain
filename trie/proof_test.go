...
func BenchmarkProve(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		proofs := memorydb.NewMemDatabase()
...
func BenchmarkVerifyProof(b *testing.B) {
	...
	root := trie.Hash()
	var keys []string
	var proofs []*memorydb.MemDatabase
	for k := range vals {
		keys = append(keys, k)
		proof := memorydb.NewMemDatabase()
