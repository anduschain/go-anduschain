...
import (
	...
	"github.com/anduschain/go-anduschain/crypto/bn256"
...
var PrecompiledContractsUlsan = map[common.Address]PrecompiledContract{
	common.BytesToAddress([]byte{1}):  &ecrecover{},
	common.BytesToAddress([]byte{2}):  &sha256hash{},
	common.BytesToAddress([]byte{3}):  &ripemd160hash{},
	common.BytesToAddress([]byte{4}):  &dataCopy{},
...
var (
	...
	PrecompiledAddressesUlsan     []common.Address
)
...
func init() {
	...
	for k := range PrecompiledContractsUlsan {
		PrecompiledAddressesUlsan = append(PrecompiledAddressesUlsan, k)
	}
}
...
func ActivePrecompiles(rules params.Rules) []common.Address {
	switch {
	case rules.IsUlsan:
		return PrecompiledAddressesUlsan
	case rules.IsPohang:
