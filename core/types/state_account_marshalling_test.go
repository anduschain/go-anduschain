...
func TestMarshalUnmarshalEmptyAccount(t *testing.T) {
	acc := StateAccount{
		...
		Root:             common.Hash{},
		CodeHash:         codehash.EmptyKeccakCodeHash.Bytes(),
...
func TestMarshalUnmarshalNonEmptyAccount(t *testing.T) {
	acc := StateAccount{
		...
		CodeHash:         common.Hex2Bytes("1111111111111111111111111111111111111111111111111111111111111111"),
...
func TestMarshalUnmarshalAccountWithMaxFields(t *testing.T) {
	...
	acc := StateAccount{
		...
		CodeHash:         common.Hex2Bytes("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"),
