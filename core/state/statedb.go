...
import (
	...
	"github.com/anduschain/go-anduschain/core/state/snapshot"
...
func (self *StateDB) Reset(root common.Hash, snaps *snapshot.Tree) error {
	...
	self.hasher = crypto.NewKeccakState()
