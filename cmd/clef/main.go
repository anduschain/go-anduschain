...
import (
	...
	"github.com/anduschain/go-anduschain/internal/flags"
	...
	"github.com/anduschain/go-anduschain/signer/core/apitypes"
	"github.com/anduschain/go-anduschain/signer/fourbyte"
...
func signer(c *cli.Context) error {
	...
	if c.GlobalBool(utils.RPCEnabledFlag.Name) {
		vhosts := utils.SplitAndTrim(c.GlobalString(utils.RPCVirtualHostsFlag.Name))
		cors := utils.SplitAndTrim(c.GlobalString(utils.RPCCORSDomainFlag.Name))
		...
		// start http server
		httpEndpoint := fmt.Sprintf("%s:%d", c.GlobalString(utils.RPCListenAddrFlag.Name), port)
...
func checkFile(filename string) error {
	...
	// https://github.com/anduschain/go-daon/issues/20123
