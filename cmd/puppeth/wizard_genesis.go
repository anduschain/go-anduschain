...
func (w *wizard) makeGenesis() {
	...
	genesis := &core.Genesis{
		...
		Config: &params.ChainConfig{
			...
			PohangBlock:    big.NewInt(5),
			UlsanBlock:     big.NewInt(6),
		},
	}
	...
	case choice == "3":
		// In the case of clique, configure the consensus parameters
		genesis.Difficulty = big.NewInt(1)
		genesis.Config.Sse = &params.SseConfig{
			Period: 3,
			Epoch:  30000,
		}
		fmt.Println()
...
func (w *wizard) manageGenesis() {
	...
	case choice == "1":
		...
		fmt.Println()
		fmt.Printf("Which block should Ulsan come into effect? (default = %v)\n", w.conf.Genesis.Config.PohangBlock)
		w.conf.Genesis.Config.UlsanBlock = w.readDefaultBigInt(w.conf.Genesis.Config.UlsanBlock)
