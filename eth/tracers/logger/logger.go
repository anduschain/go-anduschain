...
// CaptureState also tracks SLOAD/SSTORE ops to track storage change.
func (t *mdLogger) CaptureState(pc uint64, op vm.OpCode, gas, cost uint64, stack *vm.Stack, rData []byte, depth int, err error) {
...
func (t *mdLogger) CaptureFault(pc uint64, op vm.OpCode, gas, cost uint64, stack *vm.Stack, depth int, err error) {
