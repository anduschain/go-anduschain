...
import (
	...
	"github.com/anduschain/go-daon/common"
	"github.com/anduschain/go-daon/consensus/deb"
	"github.com/anduschain/go-daon/core"
	"github.com/anduschain/go-daon/core/types"
	"github.com/anduschain/go-daon/core/vm"
	"github.com/anduschain/go-daon/crypto"
	"github.com/anduschain/go-daon/eth"
	"github.com/anduschain/go-daon/eth/ethconfig"
	"github.com/anduschain/go-daon/node"
	"github.com/anduschain/go-daon/params"
...
func createGQLServiceWithTransactions(t *testing.T, stack *node.Node) {
	...
	legacyTx, _ := types.SignNewTx(key, signer, types.TxData{
	...
	// Create some blocks and import them
	chain, _ := core.GenerateChain(params.AllDebProtocolChanges, ethBackend.BlockChain().Genesis(),
		deb.NewFaker(types.NewDefaultOtprn()), ethBackend.ChainDb(), 1, func(i int, b *core.BlockGen) {
