...
const schema string = `
    ...
    type Block {
        ...
        # VoterCount is the number of voters  associated with this
        # block. If voters are unavailable, this field will be null.
        voterCount: Int
        # Voters is a list of voter associated with this block.
        # If voters are unavailable, this field will be null. Depending on your
        # node
        voters: [Address!]
        # VoterHash is the keccak256 hash of all the voters
