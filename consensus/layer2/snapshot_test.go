...
func TestLayer2(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/anduschain/go-anduschain/issues/17593). Whilst this
	...
	for i, tt := range tests {
		...
		config.Layer2 = &params.Layer2Config{
			Period: 1,
			Epoch:  tt.epoch,
		}
		engine := New(config.Layer2, db)
		...
		// Pass all the headers through layer2 and ensure tallying succeeds
