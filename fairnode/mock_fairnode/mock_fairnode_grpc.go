...
// Source: /Users/anduschain/go/src/github.com/anduschain/go-anduschain/fairnode/mock_fairnode/../../protos/fairnode/fairnode_grpc.pb.go
...
// MockUnsafeFairnodeServiceServer is a mock of UnsafeFairnodeServiceServer interface.
type MockUnsafeFairnodeServiceServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafeFairnodeServiceServerMockRecorder
}

// MockUnsafeFairnodeServiceServerMockRecorder is the mock recorder for MockUnsafeFairnodeServiceServer.
type MockUnsafeFairnodeServiceServerMockRecorder struct {
	mock *MockUnsafeFairnodeServiceServer
}

// NewMockUnsafeFairnodeServiceServer creates a new mock instance.
func NewMockUnsafeFairnodeServiceServer(ctrl *gomock.Controller) *MockUnsafeFairnodeServiceServer {
	mock := &MockUnsafeFairnodeServiceServer{ctrl: ctrl}
	mock.recorder = &MockUnsafeFairnodeServiceServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafeFairnodeServiceServer) EXPECT() *MockUnsafeFairnodeServiceServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedFairnodeServiceServer mocks base method.
func (m *MockUnsafeFairnodeServiceServer) mustEmbedUnimplementedFairnodeServiceServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedFairnodeServiceServer")
}

// mustEmbedUnimplementedFairnodeServiceServer indicates an expected call of mustEmbedUnimplementedFairnodeServiceServer.
func (mr *MockUnsafeFairnodeServiceServerMockRecorder) mustEmbedUnimplementedFairnodeServiceServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedFairnodeServiceServer", reflect.TypeOf((*MockUnsafeFairnodeServiceServer)(nil).mustEmbedUnimplementedFairnodeServiceServer))
}
...
// MockUnsafeFairnodeSyncServiceServer is a mock of UnsafeFairnodeSyncServiceServer interface.
type MockUnsafeFairnodeSyncServiceServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafeFairnodeSyncServiceServerMockRecorder
}

// MockUnsafeFairnodeSyncServiceServerMockRecorder is the mock recorder for MockUnsafeFairnodeSyncServiceServer.
type MockUnsafeFairnodeSyncServiceServerMockRecorder struct {
	mock *MockUnsafeFairnodeSyncServiceServer
}

// NewMockUnsafeFairnodeSyncServiceServer creates a new mock instance.
func NewMockUnsafeFairnodeSyncServiceServer(ctrl *gomock.Controller) *MockUnsafeFairnodeSyncServiceServer {
	mock := &MockUnsafeFairnodeSyncServiceServer{ctrl: ctrl}
	mock.recorder = &MockUnsafeFairnodeSyncServiceServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafeFairnodeSyncServiceServer) EXPECT() *MockUnsafeFairnodeSyncServiceServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedFairnodeSyncServiceServer mocks base method.
func (m *MockUnsafeFairnodeSyncServiceServer) mustEmbedUnimplementedFairnodeSyncServiceServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedFairnodeSyncServiceServer")
}

// mustEmbedUnimplementedFairnodeSyncServiceServer indicates an expected call of mustEmbedUnimplementedFairnodeSyncServiceServer.
func (mr *MockUnsafeFairnodeSyncServiceServerMockRecorder) mustEmbedUnimplementedFairnodeSyncServiceServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedFairnodeSyncServiceServer", reflect.TypeOf((*MockUnsafeFairnodeSyncServiceServer)(nil).mustEmbedUnimplementedFairnodeSyncServiceServer))
}
